...
export default function EntregadorPendentePage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
        ...
        <p className="text-gray-500 text-sm leading-relaxed mb-6">
          Recebemos sua solicitação e estamos analisando os documentos. Nossa
          equipe entrará em contato em até <strong>48 horas úteis</strong> pelo
          e-mail cadastrado.
        </p>
        ...
        <div className="bg-amber-50 rounded-xl border border-amber-100 p-4 mb-6 text-left">
          ...
          <ol className="text-sm text-amber-700 space-y-1 list-decimal list-inside">
            <li>Nossa equipe verifica sua CNH e documentos do veículo</li>
            <li>Você recebe e-mail com o resultado</li>
            <li>Se aprovado, você acessa o app e começa a receber entregas</li>
          </ol>
        </div>
