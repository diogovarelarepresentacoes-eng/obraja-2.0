...
const NAV = [
  { href: '/entregador/dashboard', label: 'Dashboard', icon: '📊' },
  { href: '/entregador/entregas', label: 'Entregas', icon: '📦' },
  { href: '/entregador/historico', label: 'Histórico', icon: '🕐' },
  { href: '/entregador/perfil', label: 'Meu Perfil', icon: '👤' },
];
    ...
    <div className="flex min-h-screen bg-gray-50">
      <aside className="w-56 bg-white border-r border-gray-100 flex flex-col">
        <div className="px-5 py-5 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-0.5">Painel do Entregador</p>
        </div>
